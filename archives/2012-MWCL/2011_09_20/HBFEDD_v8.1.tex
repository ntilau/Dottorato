...
\cite{deGersem2001}. A time-harmonic finite element (FE) approach at a single
...
\cite{Guarnieri2010, Guarnieri2009}.
...
A millimeter wave passband filter in WR6
 is here analyzed (Fig.~\ref{fig:bilat}) \cite{Guarnieri2010}. Due to symmetries, the
...
such that \cite{Guarnieri2010,Yatsyk2006}
%
\begin{equation}
